        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="card offset-md-1 col-md-10">
                        <div class="card-body">
                            <h3 class="content-title">Modification : {{ $workshop->name }}</h3>
                            <hr class="content-divider">
                            <form method="post" action="{{ route('workshop.update', $slug) }}" class="form-section"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6{{$errors->has('price') ? ' has-error' : ''}}">
                                        ...
                                        <input id="price" type="number" class="form-control" name="price" required autofocus
                                               placeholder="Prix" value="{{ $workshop->price }}" min="1">
                                        @if ($errors->has('price'))
                                            <span class="help-block">
                                    ...
                                    <div class="form-group col-md-6 {{ $errors->has('org_type') ? ' has-error' : '' }}">
                                        ...
                                        <select id="org_type" type="time" class="form-control" name="org_type"
                                                required autofocus>
                                            <option value="{{ $workshop->org_type }}">{{ $workshop->org_type }}</option>
